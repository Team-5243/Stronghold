...
=======
        */
    	...
    	addSequential(new DriveStraight(2, .8));//gets over the moat
    	addSequential(new Wait(2));
    	//addSequential(new Wait(2));
    	addSequential(new DriveStraight(42, .3));// SHOULD BE DRIVESTRAIGHTUNTILDISTANCE, 42 BEING THE DISTANCE
    	addSequential(new Turn(45));
    	addSequential(new DriveStraight(2, .2));//Want to base this on accelerometer
    	addSequential(new Turn(-45));
